...
?>
<h5><?php _e($type_names[$type] . " Number " . $i, "GFA_HUB") ?></h5>
        ...
        <div class="PassengerData">
            <div class="row p-0 m-0 gap-0 gap-md-1">
                <div class="PassengerTitle mb-3 col-12 p-0  flex-fill">
                    <label for="FirstName" class="form-label mb-0"><?php _e("Title", "GFA_HUB") ?></label>
                ...
                <div class="mb-3 col-12 p-0 col-md-5 flex-fill">
                    <label for="FirstName" class="form-label mb-0"><?php _e("First Name", "GFA_HUB") ?></label>
                    <input name="passenger_first_name_<?php echo $passenger_num ?>" type="text" class="form-control" id="FirstName" required>
                </div>
                <div class="mb-3 col-12 p-0 col-md-5 flex-fill">
                    <label for="LastName" class="form-label  mb-0"><?php _e("Last Name", "GFA_HUB") ?></label>
                ...
                <div class="mb-3 col-12 p-0">
                    <label for="email" class="form-label  mb-0"><?php _e("Email", "GFA_HUB") ?></label>
                    <input name="passenger_email_<?php echo $passenger_num ?>" type="email" class="form-control" id="email" required>
                </div>

                <div class="mb-3 col-12 p-0 col-md-5 flex-fill">
                    <label for="dbo" class="form-label  mb-0"><?php _e("Gender", "GFA_HUB") ?></label>
                    <select class="form-select" name="passenger_gender_<?php echo $passenger_num ?>" aria-label="Default select example" required>
                        <option value="M"><?php _e("Male", "GFA_HUB") ?></option>
                        <option value="F"><?php _e("Female", "GFA_HUB") ?></option>
                    </select>
                </div>

                <div class="mb-3 col-12 p-0 col-md-5 flex-fill">
                    <label for="dob" class="form-label mb-0"><?php _e("Birth Date", "GFA_HUB") ?></label>
                ...
                <div class="mb-3 col-12  flex-fill p-0">
                    <label for="areaCode" class="form-label  mb-0"><?php _e("Area Code", "GFA_HUB") ?></label>
                    <input name="passenger_area_code_<?php echo $passenger_num ?>" type="text" class="form-control" id="areaCode" required>
                </div>

                <div class="mb-3 col-12  flex-fill p-0">
                    <label for="mobile" class="form-label  mb-0"><?php _e("Mobile", "GFA_HUB") ?></label>
                    <input name="passenger_mobile_<?php echo $passenger_num ?>" type="text" class="form-control" id="mobile" required>
                </div>

                <div class="mb-3 col-12 p-0 col-md-5 flex-fill">
                    <label for="nationality" class="form-label mb-0"><?php _e("Nationality", "GFA_HUB") ?></label>
